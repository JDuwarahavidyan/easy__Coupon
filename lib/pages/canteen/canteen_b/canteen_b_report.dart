...
class CanteenBReportPage extends StatefulWidget {
  const CanteenBReportPage({super.key});

  @override
  State<CanteenBReportPage> createState() => _CanteenBReportPageState();
}

class _CanteenBReportPageState extends State<CanteenBReportPage> {
